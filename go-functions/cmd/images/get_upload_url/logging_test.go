...
func TestHandler_InternalFailureLogsCauseAndCorrelation(t *testing.T) {
	...
	original := presignClientGetter
	t.Cleanup(func() { presignClientGetter = original })
	const cause = "private dependency endpoint unavailable"
	presignClientGetter = func() (S3PresignerInterface, error) { return nil, errors.New(cause) }
